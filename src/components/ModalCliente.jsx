...
const VerCliente = ({ cliente, setmodalIsVisible }) => {
  ...
  return (
    <div className="fixed top-0 left-0 flex justify-center overflow-y-scroll items-center w-full h-screen bg-black bg-opacity-80">
      <div className="bg-slate-300 w-3/4 md:w-3/4 lg:w-1/4 xl:w-2/4 rounded-xl m-auto">
        <span
          onClick={() => {
            setmodalIsVisible(false);
          }}
          className="float-right text-white text-center leading-7 cursor-pointer bg-blue-900 font-thin text-3xl rounded-full m-1 w-7 h-7"
        >
          &times;
        </span>
